# Test dataset implementation (small subset)
import copy
...
def get_custom_dataset(dataset_config, processor, split, split_ratio=0.8):
    """
    Load a small subset of the synthetic dataset for testing.
    ...
    # Select a small subset for testing (100 samples)
...
# Required tokenization functions - copied from tokenize_dataset.py
# These are needed here because finetuning.py might import the entire module
