...
if __name__ == "__main__":
    ...
    print("="*80)
    print("This test suite verifies the functionality of the FuzzyMatcher utility")
    print("which is responsible for detecting sensitive information in text using")
    print("various matching strategies.")
    print("\nEach test will show:")
    print("  ✓ - Passed assertions")
    print("  ✗ - Failed assertions")
    print("\nDetailed match information is displayed for visual verification.")
    print("="*80)
